...
LlamaModel = Llama(model_path="YOUR_HOME_DIR/deepseek-model-gguf/DeepSeek-R1-Q4_K_M/DeepSeek-R1-Q4_K_M-00001-of-00011.gguf", n_threads=128, temp=0.6,  n_ctx=1024*12, n_gpu_layers=12)
...
def saveDS(ds, savePath="YOUR_HOME_DIR/dataset_chapters_complex_deepseek_gpu"):
